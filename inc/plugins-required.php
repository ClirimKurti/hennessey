...
require_once (MOD_TEMPLATE . '/inc/class-tgm-plugin-activation.php');
...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
            ...
            'source'             => 'https://downloads.wordpress.org/plugin/advanced-custom-fields.latest-stable.zip', // The plugin source.
		...
		array(
			...
			'source'       => 'https://downloads.wordpress.org/plugin/wordpress-seo.latest-stable.zip', // The plugin source.
	 ...
	 */
	$config = array(
		'id'           => 'web-agency',                 // Unique ID for hashing notices for multiple instances of TGMPA.
		'default_path' => '',                      // Default absolute path to bundled plugins.
		'menu'         => 'web-agency-install-plugins', // Menu slug.
